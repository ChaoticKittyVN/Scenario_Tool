...
class MainWindowUI:
    ...
    def _create_config_tab(self):
        ...
        # 本机设置不写入项目 config.yaml。
        local_group = QGroupBox("本机 GUI 设置")
        local_layout = QVBoxLayout()
        python_layout = QHBoxLayout()
        python_layout.addWidget(QLabel("工具 Python:"))
        self.config_python_edit = QLineEdit()
        self.config_python_edit.setReadOnly(True)
        python_layout.addWidget(self.config_python_edit, 1)
        self.config_python_btn = QPushButton("浏览...")
        python_layout.addWidget(self.config_python_btn)
        self.config_python_auto_btn = QPushButton("自动")
        python_layout.addWidget(self.config_python_auto_btn)
        local_layout.addLayout(python_layout)

        local_status_layout = QHBoxLayout()
        self.config_python_status = QLabel()
        local_status_layout.addWidget(self.config_python_status)
        local_status_layout.addStretch()
        self.config_local_save_btn = QPushButton("保存本机设置")
        local_status_layout.addWidget(self.config_local_save_btn)
        ...
        self.config_save_btn = QPushButton("保存项目配置")
